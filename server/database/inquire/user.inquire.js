exports.query = {
  ...
  getInfoById: [
    "select icon.user_icon_id,prof.profession_name,icon.user_icon_path,info.user_self,info.user_nickname\n" +
    "from user u \n" +
    ...
    "select count(1) count from collect where user_col_id=?",
    "select count(1) count from dynamic where user_id=?"
  ],
  ...
  "and u.profession_id=prof.profession_id\n" +
  "and u.user_id=icon.user_id\n" +
  "and (prof.profession_name regexp ? or info.user_nickname regexp ?)",
