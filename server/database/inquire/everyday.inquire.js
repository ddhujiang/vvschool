exports.query = {
  ...
  getEDay:"select dy.user_id,dy.dynamic_id,ic.user_icon_path,info.user_nickname,info.user_self,dy.dy_time,dy.dy_content,dy.like_num,dcomm.sumdcm,dtran.sumdt\n" +
  "from view_icon ic\n" +
  "join user_icon icon\n" +
  "join user_info info\n" +
  "join dynamic dy \n" +
